...
public partial class WebRestOracleContext : DbContext
{
    ...
    public virtual DbSet<OrdersLine> OrdersLine { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            ...
            entity.HasOne(d => d.CustomerGender).WithMany(p => p.Customer).HasConstraintName("CUSTOMER_FK1");
        });
        ...
        modelBuilder.Entity<CustomerAddress>(entity =>
        {
            ...
            entity.HasOne(d => d.CustomerAddressAddressType).WithMany(p => p.CustomerAddress)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<OrderState>(entity =>
        {
            ...
            entity.HasOne(d => d.OrderStateOrderStatus).WithMany(p => p.OrderState)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("ORDER_STATE_FK2");

            entity.HasOne(d => d.OrderStateOrders).WithMany(p => p.OrderState)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<OrdersLine>(entity =>
        {
            ...
            entity.HasOne(d => d.OrdersLineOrders).WithMany(p => p.OrdersLine)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("ORDERS_LINE_FK1");

            entity.HasOne(d => d.OrdersLineProduct).WithMany(p => p.OrdersLine)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Product>(entity =>
        {
            ...
            entity.HasOne(d => d.ProductProductStatus).WithMany(p => p.Product)
                .OnDelete(DeleteBehavior.ClientSetNull)
